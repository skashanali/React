...
React.DOM.thead({onClick: this._sort, className:"bg-primary"},
React.DOM.tr(null,
...
React.DOM.tbody({onDoubleClick: this._showEditor},  this._renderSearch(),
...
React.DOM.button({
onClick: this._toggleSearch, className:"btn btn-success"
}, 'Search'),
React.DOM.a({
